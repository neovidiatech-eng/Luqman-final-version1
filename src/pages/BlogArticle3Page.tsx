...
export default function BlogArticle3Page() {
  ...
  const relatedPosts = blogPosts.filter((p) => p.slug !== 'how-to-choose-right-property');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          <article className="lg:col-span-3">
            ...
            <div className="mt-8 flex items-center gap-3 pt-6 border-t border-gray-100">
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent('كيف تختار العقار المناسب في السعودية — ' + window.location.href)}`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('معايير اختيار العقار المناسب')}&url=${encodeURIComponent(window.location.href)}`}
                target="_blank"
                rel="noopener noreferrer"
