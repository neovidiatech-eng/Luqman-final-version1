...
export default function PropertiesPage() {
  ...
  return (
    <div className="min-h-screen pt-20">
      {/* Hero */}
      <section className="gradient-hero py-16 pattern-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto">
              أكثر من {sampleProperties.length} عقار متاح في أبرز مدن المملكة. ابحث حسب المدينة والنوع والسعر والمساحة.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <p className="text-gray-600 text-sm">
              عرض <span className="font-bold text-primary">{filtered.length}</span> من أصل <span className="font-bold">{sampleProperties.length}</span> عقار
            </p>
            {/* Active filter chips */}
