...
export default function BlogArticle2Page() {
  ...
  const relatedPosts = posts.filter((p) => p.slug !== 'common-mistakes-first-time-buyers');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
          <article className="lg:col-span-3">
            ...
            <div className="mt-8 flex items-center gap-3 pt-6 border-t border-gray-100">
              ...
              <a
                href={`https://wa.me/?text=${encodeURIComponent('أخطاء شائعة عند شراء أول عقار — ' + pageUrl)}`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('أخطاء شراء العقار في السعودية')}&url=${encodeURIComponent(pageUrl)}`}
                target="_blank"
                rel="noopener noreferrer"
