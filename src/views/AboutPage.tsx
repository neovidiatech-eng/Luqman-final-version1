          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="flex gap-4">
                <Link href="/contact" className="btn-gold px-6 py-3 rounded-xl font-bold text-sm">
                  تواصل معنا
                </Link>
                <Link href="/properties" className="border-2 border-white/30 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-white/10 transition-colors">
                  تصفح العقارات
                </Link>
              </div>
            </motion.div>
      ...
      <section className="py-20 gradient-primary pattern-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <Link href="/projects" className="btn-gold px-7 py-3.5 rounded-xl font-bold text-sm inline-flex items-center gap-2">
              اكتشف مشاريعنا
              <ArrowLeft className="w-4 h-4" />
            </Link>
          </div>
